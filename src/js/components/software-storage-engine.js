...
class SoftwareStorageEngine {
  view() {
    return layout('software-storage-engine', [
      ...
      content([
        m(Paragraph, { content: 'The Tidemann&Co Storage Engine is an application for storing files. Optimized for storing large files across clusters of servers, it allows for simple access through interfaces familiar to any developer.' }),
